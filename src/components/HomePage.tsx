...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  return (
    <div className={`space-y-16 sm:space-y-24 pb-20 ${isLowSignalGlobal ? 'bg-slate-950 text-slate-100' : ''}`}>
      ...
      <section className="relative min-h-[620px] sm:min-h-[720px] flex items-center overflow-hidden bg-[#230B15]">
        
        {/* Uploaded Real Image Background (Anchored Right on Desktop, Center/Top on Mobile) */}
        <motion.div
        ...
        >
          <img
            ...
            className="w-full h-full object-cover object-[center_top] sm:object-[82%_center] filter brightness-95"
          />

          {/* Dark Maroon/Charcoal Gradient Overlay (Strongest on Left, Fades Before Reaching Her Face) */}
          <div className="absolute inset-0 bg-gradient-to-r from-[#230B15]/95 via-[#230B15]/80 to-transparent w-full sm:w-[62%] lg:w-[55%]" />
          <div className="absolute inset-0 bg-gradient-to-t from-[#230B15] via-transparent to-black/30" />
        </motion.div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 text-white">
          <div className="max-w-2xl space-y-6">
            ...
            >
              HerPath helps you choose a journey that fits the moment — with clearer options, useful journey signals, and support when you need it.
            </motion.p>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <h2 className={`text-2xl sm:text-3xl font-bold ${isLowSignalGlobal ? 'text-white' : 'text-slate-900'}`}>
            Why Women Choose <span className="text-brand-purple">HerPath</span>
          </h2>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="space-y-4 text-center md:text-left">
              ...
              >
                ...
                <span className="font-bold text-lg text-white group-hover:underline">HerPath Privacy Pledge</span>
              ...
              <p className="text-purple-200 text-sm max-w-xl">
                We never store your search origins, destinations, or real-time location. HerPath provides objective environmental data so you navigate with total independence.
              </p>
