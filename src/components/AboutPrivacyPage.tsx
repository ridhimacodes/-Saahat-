    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-16 space-y-12">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-slate-600 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
          HerPath is built to empower women with real environmental context while respecting absolute data dignity.
        </p>
      </div>
          ...
          <ul className="space-y-4 text-sm text-slate-700">
            ...
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <span>HerPath is independent and free from third-party advertising trackers.</span>
              </div>
            </li>
          </ul>
        </motion.div>
      ...
      >
        ...
        <p className="text-purple-100 text-base leading-relaxed max-w-3xl">
          Women deserve travel companions that provide factual, objective environmental context without inducing anxiety or restricting freedom. By focusing on streetlights, business hours, and transit hubs, HerPath supports your independence and peace of mind on every journey.
        </p>
